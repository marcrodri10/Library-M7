...
<body class="b-flex-center-center-row">
    <div class="form-container">
        ...
        <form class="form" action='/register/formHandler' method="post">
            ...
            <input type="password" class="input" placeholder="Confirm Password" name="confirmpass" required>
        ...
        <p class="sign-up-label">
            Have an account?<a href="/login" class="sign-up-link">Sign in</a>
        </p>
        <div class="buttons-container">
            <div class="apple-login-button">
                ...
                <span>Register in with Apple</span>
            </div>
